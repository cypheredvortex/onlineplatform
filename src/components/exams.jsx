      ...
      <>
        <div id="testskills">
          ...
          <div className="exfirstset">
            <Link to=""><Card title="HTML" src="images/htmlpic.png"/></Link>
            <Link to=""><Card title="CSS" src="images/csspic.png"/></Link>
            <Link to=""><Card title="JavaScript" src="images/jspic.jpg"/></Link>
        </div>
        <br/><br/>
        <div className="exsecondset">
            <Link to=""><Card title="PHP" src="images/phppic.png"/></Link>
            <Link to=""><Card title="SQL" src="images/sqlpic.png"/></Link>
            <Link to=""><Card title="Python" src="images/pypic.jpeg"/></Link>
        </div>
        <br/><br/>
        <div className="exthirdset">
            <Link to=""><Card title="C" src="images/cpic.webp"/></Link>
            <Link to=""><Card title="C#" src="images/csharp.webp"/></Link>
            <Link to=""><Card title="C++" src="images/cpp.avif"/></Link>
        </div>
        <br/><br/>
        <div className="exforthset">
            <Link to=""><Card title="TypeScript" src="images/typescriptpic.jpg"/></Link>
            <Link to=""><Card title="Ruby" src="images/rubypic.png"/></Link>
            <Link to=""><Card title="Swift" src="images/swiftpic.webp"/></Link>
        </div>
        <br/><br/>
        <div className="exfifthset">
            <Link to=""><Card title="Go" src="images/gopic.jpg"/></Link>
            <Link to=""><Card title="R" src="images/rpic.webp"/></Link>
            <Link to=""><Card title="Kotlin" src="images/kotlinpic.jpg"/></Link>
        </div>
        <br /><br /><br /><br /><br />
        </div>
      </>
